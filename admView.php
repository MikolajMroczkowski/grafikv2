...
<div class="centered">
    ...
    <button class='btn btn-success'
            onclick="window.open('admExport.php?mc='+document.getElementById('mc').value+'&year='+document.getElementById('year').value);">
        Exportuj
    </button>
    <br>
    <h2>Formatka</h2>
    ...
    $conn->close();
    ?>
    <input id="row" placeholder="Wiersz" style="width:75px">
    <button onclick="createExportForUser(document.getElementById(`user`).options[document.getElementById(`user`).selectedIndex].value,document.getElementById(`row`).value)"
